...
baselinev="Delta" # input("Baseline variant")
debug=False
...
if plot_multinomial_comparison:
    ...
    aic_poly = n_points * np.log(rss_poly / n_points) + 2 * k_poly  # maybe parameter weighting is not enough? could be increased considering very low values and diff
